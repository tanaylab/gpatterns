...
#' @export
qq <- GetoptLong::qq
qqu <- function(..., envir=parent.frame()) qq(..., collapse=FALSE, envir=envir)
...
.gpatterns.n_track_name       <- function(track) { qqu('@{track}.n')}
.gpatterns.n0_track_name      <- function(track) { qqu('@{track}.n0')}
.gpatterns.n1_track_name      <- function(track) { qqu('@{track}.n1')}
.gpatterns.nx_track_name      <- function(track) { qqu('@{track}.nx')}
.gpatterns.nc_track_name      <- function(track) { qqu('@{track}.nc')}
.gpatterns.pat_meth_track_name    <- function(track) { qqu('@{track}.pat_meth')}
.gpatterns.epipolymorphism_track_name <- function(track) { qqu('@{track}.epipoly')}

.gpatterns.mix_qval_track_name <- function(track) { qqu('@{track}.mix_qval')}
.gpatterns.mix_meth_track_name <- function(track) { qqu('@{track}.mix_meth')}
.gpatterns.mix_unmeth_track_name <- function(track) { qqu('@{track}.mix_unmeth')}
.gpatterns.gain_meth_track_name <- function(track) { qqu('@{track}.gain_meth')}
.gpatterns.gain_unmeth_track_name <- function(track) { qqu('@{track}.gain_unmeth')}
.gpatterns.loss_meth_track_name <- function(track) { qqu('@{track}.loss_meth')}
.gpatterns.loss_unmeth_track_name <- function(track) { qqu('@{track}.loss_unmeth')}
.gpatterns.center_meth_track_name <- function(track) { qqu('@{track}.center_meth_ones')}
.gpatterns.center_unmeth_track_name <- function(track) { qqu('@{track}.center_unmeth_ones')}
.gpatterns.center_uni_track_name <- function(track) { qqu('@{track}.center_uni_ones')}
.gpatterns.gain_uni_track_name <- function(track) { qqu('@{track}.gain_uni')}
.gpatterns.loss_uni_track_name <- function(track) { qqu('@{track}.loss_uni')}
